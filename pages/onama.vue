        ...
        <div class="w-full md:w-2/5 py-6 text-center">
          <div class=' '>
            <div
              ...
              <p class="text-sm text-start font-medium text-gray-500">8 global ratings</p>
              ...
              <div class="md:grid md:grid-cols-2 gap-2 lg:grid-cols-1 text-start">
                <div class="mt-4">
                  <p class="text-sm text-pink-500 dark:text-pink-400">
                    "Rated the best service at the best price!"
                  </p>
                  <p class="text-xs mt-2 text-zinc-500"> <span class="block text-xs">Rudolf</span> </p>
                </div>
