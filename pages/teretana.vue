    ...
    <section class="content-section bg-white py-16 -my-[1px]" id="businesses">
      <div class="container mx-auto px-4 lg:px-5">
        <h2 class="w-full my-2 text-4xl font-bold leading-tight text-center text-gray-800">
          Teretana | Fitness centar
        </h2>
        <div class="w-full mb-4">
          <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        <p class='text-xl text-center w-full px-5'>
          Digitalizacija poslovanja teretana
          <br>
          - Osnovna web stranica (1-4 stranice)
          <br>
          - Sistem za upravljanje članarinama (Napredna web stranica)
          <br>
          - Napredna web aplikacija (Napredna web aplikacija isključivo za klijente u sistemu za upravljanje
          članarinama, koja vam omogućuje integraciju programa treninga)
          <br>
