      ...
      <table class="max-w-md text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          <tr class="bg-white dark:bg-gray-800">
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              <a class="text-blue-500 underline" target="_blank"
                ...
                Apple Macbook Pro 16, M3 Max 16C-40C, 48GB, 1TB, Silver</a>
            </th>
          ...
          <tr class="bg-white dark:bg-gray-800">
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              <a class="text-blue-500 underline" target="_blank"
                href="https://ukstore.hermanmiller.com/collections/seating/products/aeron-graphite-standard-office-chair">
                Glavna radna Stolica - Aeron Office Chair</a>
            </th>
            <td class="px-6 py-4">1564€</td>
          </tr>
          <tr class="bg-white dark:bg-gray-800">
            <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
              <a class="text-blue-500 underline" target="_blank"
